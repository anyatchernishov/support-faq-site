...
// The site renders these automatically, grouped by category. `answer` may contain
// simple HTML (<strong>, <a>, <code>) for formatting.
//
//   { question: "…", answer: "…", category: "getting-started" }
//
// Valid categories (must match sidebar topics):
//   getting-started | automations | integrations | security | account | billing
