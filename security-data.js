...
// simple HTML (<strong>, <a>, <code>, inline <svg>) for formatting.
//
...
window.SECURITY_ITEMS = [
  ...
  },
  {
    ...
    answer: "<p>If you lose your authenticator device, you can sign in with a backup code or ask an Admin to reset 2FA for you.</p><p><strong>Step 1 — Use a backup code at login</strong></p><svg class="qa-illustration" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 220" role="img" aria-label="Mock screenshot: login screen with backup code option"><rect width="640" height="220" rx="12" fill="#f4f5f7"/><rect x="170" y="24" width="300" height="172" rx="12" fill="#fff" stroke="#e5e7ef" stroke-width="2"/><text x="320" y="56" text-anchor="middle" fill="#323338" font-size="15" font-family="system-ui,sans-serif" font-weight="600">Sign in to FlowDeck</text><rect x="190" y="72" width="260" height="34" rx="6" fill="#f9fafb" stroke="#e5e7ef" stroke-width="1.5"/><text x="204" y="94" fill="#676879" font-size="12" font-family="system-ui,sans-serif">you@company.com</text><rect x="190" y="116" width="260" height="34" rx="6" fill="#f9fafb" stroke="#e5e7ef" stroke-width="1.5"/><text x="204" y="138" fill="#676879" font-size="12" font-family="system-ui,sans-serif">Password</text><rect x="190" y="160" width="260" height="28" rx="6" fill="#5b52e8"/><text x="320" y="179" text-anchor="middle" fill="#fff" font-size="12" font-family="system-ui,sans-serif" font-weight="600">Sign in</text><rect x="500" y="72" width="120" height="120" rx="10" fill="#fff" stroke="#5b52e8" stroke-width="+2"/><text x="560" y="96" text-anchor="middle" fill="#5b52e8" font-size="11" font-family="system-ui,sans-serif" font-weight="600">Use backup code</text><rect x="512" y="108" width="96" height="34" rx="6" fill="#f9fafb" stroke="#e5e7ef" stroke-width="1.5"/><text x="524" y="130" fill="#676879" font-size="11" font-family="monospace">ABCD-1234</text><path d="M450 132 L496 132" stroke="#5b52e8" stroke-width="2" fill="none" marker-end="url(#arrow2)"/><defs><marker id="arrow2" markerWidth="8" markerHeight="8" refX="6" refY="4" orient="auto"><path d="M0,0 L8,4 L0,8 Z" fill="#5b52e8"/></marker></defs></svg><p>On the login screen, click <strong>Use backup code</strong> and enter one of the codes you saved when you enabled 2FA.</p><p><strong>Step 2 — Ask an Admin to reset 2FA</strong></p><svg class="qa-illustration" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 220" role="img" aria-label="Mock screenshot: admin team settings with Reset 2FA action"><rect width="640" height="220" rx="12" fill="#f4f5f7"/><rect x="24" y="24" width="180" height="172" rx="10" fill="#fff" stroke="#e5e7ef" stroke-width="2"/><rect x="24" y="24" width="180" height="36" rx="10" fill="#eef0f3"/><text x="40" y="47" fill="#323338" font-size="13" font-family="system-ui,sans-serif" font-weight="600">Settings</text><rect x="36" y="72" width="156" height="28" rx="6" fill="#ede9fe" stroke="#5b52e8" stroke-width="1.5"/><text x="48" y="91" fill="#5b52e8" font-size="12" font-family="system-ui,sans-serif" font-weight="600">Team</text><rect x="220" y="24" width="396" height="172" rx="10" fill="#fff" stroke="#e5e7ef" stroke-width="2"/><text x="240" y="52" fill="#323338" font-size="14" font-family="system-ui,sans-serif" font-weight="600">Team members</text><rect x="240" y="68" width="356" height="44" rx="8" fill="#f9fafb" stroke="#e5e7ef" stroke-width="1.5"/><circle cx="262" cy="90" r="12" fill="#5b52e8"/><text x="258" y="94" fill="#fff" font-size="10" font-family="system-ui,sans-serif" font-weight="600">A</text><text x="284" y="86" fill="#323338" font-size="12" font-family="system-ui,sans-serif" font-weight="600">Alex Rivera</text><text x="284" y="102" fill="#676879" font-size="11" font-family="system-ui,sans-serif">alex@company.com · 2FA enabled</text><rect x="500" y="78" width="84" height="24" rx="6" fill="#fff" stroke="#5b52e8" stroke-width="1.5"/><text x="542" y="94" text-anchor="middle" fill="#5b52e8" font-size="11" font-family="system-ui,sans-serif" font-weight="600">Reset 2FA</text><rect x="240" y="124" width="356" height="44" rx="8" fill="#fff" stroke="#e5e7ef" stroke-width="1.5"/><circle cx="262" cy="146" r="12" fill="#00c875"/><text x="258" y="150" fill="#fff" font-size="10" font-family="system-ui,sans-serif" font-weight="600">B</text><text x="284" y="142" fill="#323338" font-size="12" font-family="system-ui,sans-serif" font-weight="600">Blake Chen</text><text x="284" y="158" fill="#676879" font-size="11" font-family="system-ui,sans-serif">blake@company.com</text></svg><p>If you no longer have backup codes, an account Admin can reset 2FA from <strong>Settings → Team → [your name] → Reset 2FA</strong>. For Enterprise accounts with SSO enforced, contact your IdP administrator to restore access.</p>"
  },
  {
    subcategory: "authentication",
